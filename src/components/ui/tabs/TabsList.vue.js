...
function __VLS_template() {
    ...
    var __VLS_0 = __VLS_resolvedLocalAndGlobalComponents.TabsList;
    /** @type { [typeof __VLS_components.TabsList, typeof __VLS_components.TabsList, ] } */
    // @ts-ignore
    var __VLS_1 = __VLS_asFunctionalComponent(__VLS_0, new __VLS_0(__assign(__assign({}, (__VLS_ctx.delegatedProps)), { class: ((__VLS_ctx.cn('inline-flex items-center justify-center rounded-md bg-muted p-1 text-muted-foreground', props.class))) })));
    var __VLS_2 = __VLS_1.apply(void 0, __spreadArray([__assign(__assign({}, (__VLS_ctx.delegatedProps)), { class: ((__VLS_ctx.cn('inline-flex items-center justify-center rounded-md bg-muted p-1 text-muted-foreground', props.class))) })], __VLS_functionalComponentArgsRest(__VLS_1), false));
    var __VLS_6 = {};
    var __VLS_7 = {};
