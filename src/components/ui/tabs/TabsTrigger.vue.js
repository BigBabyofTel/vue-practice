...
var forwardedProps = (0, radix_vue_1.useForwardProps)(delegatedProps); /* PartiallyEnd: #3632/scriptSetup.vue */
...
function __VLS_template() {
    ...
    var __VLS_0 = __VLS_resolvedLocalAndGlobalComponents.TabsTrigger;
    ...
    var __VLS_2 = __VLS_1.apply(void 0, __spreadArray([__assign(__assign({}, (__VLS_ctx.forwardedProps)), { class: ((__VLS_ctx.cn('inline-flex items-center justify-center whitespace-nowrap rounded-sm px-3 py-1.5 text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 data-[state=active]:bg-background data-[state=active]:text-foreground data-[state=active]:shadow-sm', props.class))) })], __VLS_functionalComponentArgsRest(__VLS_1), false));
    var __VLS_6 = {};
    __VLS_elementAsFunction(__VLS_intrinsicElements.span, __VLS_intrinsicElements.span)(__assign({ class: ("truncate") }));
    var __VLS_7 = {};
...
var __VLS_self = (await Promise.resolve().then(function () { return require('vue'); })).defineComponent({
    setup: function () {
        return {
            cn: utils_1.cn,
            TabsTrigger: radix_vue_1.TabsTrigger,
